---
description: 'Implementation of Rock, Paper, Scissors, Lizard and Spock Game Using Python language'
keywords: ['python program', rock, paper, scissors, lizard, spock, game]
tags: [python]
date: 2014-03-23T00:00:00.000Z
---
<p itemprop="articleBody">Rock Paper Scissors Lizard Spock Game implemented through simple if &amp; else conditions in python.</p>
