...
const Avatar = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { title: this.name }, index.h("div", { class: 'avatar-container' }, index.h("div", { class: cssCls.join(' '), style: { width: this.size, height: this.size, fontSize: this.getFontSize() } }, (() => {
      if (this.src) {
        return index.h("img", { class: 'image', src: this.src, alt: this.name });
      }
      else {
        return index.h("div", { class: 'initials' }, this.getInitials());
      }
    })()))));
  }
...
exports.goat_avatar = Avatar;

//# sourceMappingURL=goat-avatar.cjs.entry.js.map