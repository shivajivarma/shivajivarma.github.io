...
const Canvas = class {
  ...
  render() {
    return index.h(index.Host, null, index.h("div", { class: 'canvas-wrapper', style: {
        'background-size': `${this.unitSize}px ${this.unitSize}px`,
        'background-position': `${this.unitSize / 2}px ${this.unitSize / 2}px`,
      } }, index.h("svg", { class: 'canvas', viewBox: `${this.computedViewbox.x * this.unitSize} ${this.computedViewbox.x * this.unitSize} ${this.computedViewbox.width * this.unitSize} ${this.computedViewbox.height * this.unitSize}` }, (this.paths.map((path) => {
      return index.h("path", { class: 'line clickable', "stroke-width": '4', "stroke-linecap": 'round', "stroke-linejoin": 'round', stroke: '#000', d: `${path}`, fill: 'none' });
    })))));
  }
...
exports.goat_canvas = Canvas;

//# sourceMappingURL=goat-canvas.cjs.entry.js.map