...
const SidenavMenu = class {
  ...
  renderEmptyState() {
    if (this.empty)
      return index.h("goat-empty-state", { class: "empty-menu" }, index.h("div", { slot: 'title' }, this.internalEmptyState.title), index.h("div", { slot: 'description' }, this.internalEmptyState.description));
  }
...
exports.goat_sidenav_menu = SidenavMenu;

//# sourceMappingURL=goat-sidenav-menu.cjs.entry.js.map