...
const Menu = class {
  ...
  render() {
    return index.h("div", { class: 'menu' }, index.h("slot", null), this.renderEmptyState());
  }
  renderEmptyState() {
    if (this.empty)
      return index.h("goat-empty-state", Object.assign({ class: 'empty-menu' }, this.internalEmptyState));
  }
...
const Tag = class {
  constructor(hostRef) {
    ...
    this.goatTagDismissClick = index.createEvent(this, "goat:tag-dismiss", 7);
    /**
     * Text size.
     */
    this.size = 'md';
  ...
  renderCloseButton() {
    ...
    return index.h("button", { class: 'close-btn', onClick: () => this.dismissClickHandler() }, index.h("goat-icon", { class: 'close-btn-icon inherit', name: 'x', size: size }));
  }
  render() {
    return (index.h(index.Host, null, index.h("div", { class: { 'tag': true, [`size-${this.size}`]: true } }, index.h("div", { class: 'tag-content' }, index.h("slot", null)), this.renderCloseButton())));
  }
  get elm() { return index.getElement(this); }
};
Tag.style = tagCss;
...
const Text = class {
  ...
  renderHeading() {
    ...
    return (index.h(HeadingTag, { class: 'heading' }, index.h("slot", null)));
  }
  renderParagraph() {
    return (index.h("p", { class: { 'paragraph': true, [`size-${this.size}`]: true } }, index.h("slot", null)));
  }
  renderText() {
    return (index.h("span", { class: { 'text': true, [`size-${this.size}`]: true } }, index.h("slot", null)));
  }
};
Text.style = textCss;

exports.goat_menu = Menu;
exports.goat_menu_item = GoatMenu;
exports.goat_tag = Tag;
exports.goat_text = Text;

//# sourceMappingURL=goat-menu_4.cjs.entry.js.map