...
const Button = class {
  constructor(hostRef) {
    ...
    this.goatClick = index.createEvent(this, "goat:click", 7);
    ...
    this.renderIcon = () => {
      return index.h("goat-icon", { name: this.icon, size: this.getIconSize(), class: 'icon inherit' });
    };
  ...
  getIconSize() {
    switch (this.size) {
      case utils.ElementSize.SMALL:
        return 'sm';
      case utils.ElementSize.LARGE:
        return 'md';
      case utils.ElementSize.X_LARGE:
        return 'md';
      case utils.ElementSize.XX_LARGE:
        return 'lg';
      default:
        return 'sm';
    }
  ...
  renderDisabledReason() {
    if (this.disabled && this.disabledReason)
      return index.h("div", { id: `disabled-reason-${this.gid}`, role: 'tooltip', class: 'sr-only' }, this.disabledReason);
  }
  render() {
    ...
    return (index.h(index.Host, { "has-focus": this.hasFocus, active: this.isActive }, index.h("div", { class: {
        button: true,
        [`size-${this.size}`]: true,
        block: this.block,
      ...
      } }, index.h("div", { class: 'button-background' }), index.h(NativeElementTag, Object.assign({ class: 'native-button', tabindex: this.tabindex, href: this.href, target: this.target, ref: input => this.nativeInput = input, onBlur: this.blurHandler, onFocus: this.focusHandler, onClick: this.clickHandler, onMouseDown: this.mouseDownHandler, onKeyDown: this.keyDownHandler, "aria-describedby": this.disabled && this.disabledReason ? `disabled-reason-${this.gid}` : null, "aria-disabled": (this.disabled || this.showLoader) + '' }, this.configAria), index.h("div", { class: 'button-content' }, this.showLoader && index.h("goat-spinner", { class: 'spinner inherit', size: this.getIconSize() }), !this.showLoader && this.icon && this.renderIcon(), !this.showLoader && index.h("div", { class: 'slot-container' }, index.h("slot", null)))), this.renderDisabledReason())));
  }
...
const Spinner = class {
  ...
  getSize() {
    let size;
    if (this.size === utils.ElementSize.SMALL)
      size = '1.25rem';
    else if (!this.size || this.size === utils.ElementSize.MEDIUM)
      size = '1.5rem';
    else if (this.size === utils.ElementSize.LARGE)
      size = '1.75rem';
    else if (this.size === utils.ElementSize.X_LARGE)
      size = '2rem';
    else
      size = this.size;
    return size;
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: 'spinner' }, index.h("svg", { version: '1.1', class: 'loader icon-svg', x: '0px', y: '0px', width: this.getSize(), height: this.getSize(), viewBox: '0 0 50 50', fill: 'currentColor' }, index.h("path", { d: 'M43.935,25.145c0-10.318-8.364-18.683-18.683-18.683c-10.318,0-18.683,8.365-18.683,18.683h4.068c0-8.071,6.543-14.615,14.615-14.615c8.072,0,14.615,6.543,14.615,14.615H43.935z' }, index.h("animateTransform", { attributeType: 'xml', attributeName: 'transform', type: 'rotate', from: '0 25 25', to: '360 25 25', dur: '0.6s', repeatCount: 'indefinite' }))))));
  }
};
Spinner.style = spinnerCss;

exports.goat_button = Button;
exports.goat_icon = Icon;
exports.goat_spinner = Spinner;

//# sourceMappingURL=goat-button_3.cjs.entry.js.map