...
const Card = class {
  ...
  render() {
    return (index.h(index.Host, { "shadow-level": this.shadowLevel }, index.h("div", { class: "card" }, index.h("slot", null))));
  }
};
Card.style = cardCss;

exports.goat_card = Card;

//# sourceMappingURL=goat-card.cjs.entry.js.map