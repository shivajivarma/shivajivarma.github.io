...
const TabsList = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: { 'tabs-list': true, [`variant-${this.variant}`]: true } }, index.h("div", { class: "tabs-container" }, index.h("slot", null)))));
  }
  get elm() { return index.getElement(this); }
};
TabsList.style = tabsListCss;

exports.goat_tabs_list = TabsList;

//# sourceMappingURL=goat-tabs-list.cjs.entry.js.map