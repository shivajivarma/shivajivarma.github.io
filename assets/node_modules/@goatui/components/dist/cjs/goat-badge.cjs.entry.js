...
const Badge = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: 'badge' }, this.content && index.h("div", { class: 'badge-content' }, this.content), index.h("slot", null))));
  }
};
Badge.style = badgeCss;

exports.goat_badge = Badge;

//# sourceMappingURL=goat-badge.cjs.entry.js.map