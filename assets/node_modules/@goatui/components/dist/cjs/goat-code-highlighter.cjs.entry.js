...
const PRISM_VERSION = '1.27.0';
async function loadPrism() {
  // @ts-ignore
  await utils.loadScript(`https://cdnjs.cloudflare.com/ajax/libs/prism/${PRISM_VERSION}/prism.js`);
}
...
const CodeHighlighter = class {
  ...
  render() {
    return (index.h(index.Host, null, this.compiledCode && index.h("div", { class: 'code-highlighter' }, index.h("div", { class: 'scroll-wrapper' }, index.h("div", { class: { 'line-numbers-wrapper': true, 'line-numbers': this.lineNumbers } }, index.h("pre", { dir: 'ltr', class: 'highlighter line-numbers', innerHTML: this.compiledCode }))), index.h("goat-button", { class: 'copy-btn color-secondary', size: 'sm', variant: 'ghost', icon: 'files', "aria-label": 'Copy code', title: 'Copy code', "onGoat:click": () => {
        this.handleCopyClick();
      } })), !this.compiledCode && index.h("div", { class: 'code-loader' }, index.h("goat-spinner", { class: 'rainbow' }), "Loading code...")));
  }
...
exports.goat_code_highlighter = CodeHighlighter;

//# sourceMappingURL=goat-code-highlighter.cjs.entry.js.map