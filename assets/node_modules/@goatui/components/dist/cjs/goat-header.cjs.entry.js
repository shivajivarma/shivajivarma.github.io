...
const Header = class {
  ...
  renderLeftSection() {
    return (index.h("div", { class: 'left-section section' }, index.h("slot", { name: 'left-section' })));
  }
  renderRightSection() {
    return (index.h("div", { class: 'right-section section' }, index.h("slot", { name: 'right-section' })));
  }
  render() {
    return (index.h("header", { class: { 'header': true } }, index.h("div", { class: 'header-content' }, this.renderLeftSection(), this.renderRightSection())));
  }
};
Header.style = headerCss;

exports.goat_header = Header;

//# sourceMappingURL=goat-header.cjs.entry.js.map