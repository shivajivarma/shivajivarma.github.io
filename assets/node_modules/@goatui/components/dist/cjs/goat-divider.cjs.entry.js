...
const Divider = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: {
      ...
      } }, index.h("div", { class: "line" }), index.h("div", { class: 'slot-container' }, index.h("slot", null)), index.h("div", { class: "line" }))));
  }
  get elm() { return index.getElement(this); }
};
Divider.style = dividerCss;

exports.goat_divider = Divider;

//# sourceMappingURL=goat-divider.cjs.entry.js.map