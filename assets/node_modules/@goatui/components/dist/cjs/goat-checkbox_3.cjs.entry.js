...
const Checkbox = class {
  constructor(hostRef) {
    ...
    this.goatBlur = index.createEvent(this, "goat:blur", 7);
    this.goatFocus = index.createEvent(this, "goat:focus", 7);
  ...
  render() {
    return (index.h(index.Host, { "has-focus": this.hasFocus, active: this.isActive }, index.h("label", { class: {
        'checkbox': true,
      ...
      } }, index.h("div", Object.assign({ class: 'box', tabindex: this.tabindex, ref: elm => this.iconContainer = elm, onKeyUp: (evt) => {
        if (evt.keyCode === 13) {
          this.clickHandler(evt);
        }
      }, onMouseDown: this.mouseDownHandler, onKeyDown: this.keyDownHandler, onBlur: this.blurHandler, onFocus: this.focusHandler, role: "checkbox", "aria-disabled": this.disabled + '', "aria-required": this.required + '', "aria-checked": this.value + '' }, this.configAria), index.h("div", { class: {
        'tick': true,
        'animate': this.animate,
      } })), index.h("input", { type: 'checkbox', class: 'input-native', name: this.name, value: this.value + '', checked: this.value, "aria-hidden": 'true', required: this.required, ref: elm => this.nativeInput = elm, tabindex: '-1', onClick: this.clickHandler }), index.h("div", { class: 'slot-container' }, index.h("slot", null)))));
  }
...
const FormControl = class {
  ...
  renderLabel() {
    if (this.label)
      return index.h("label", { class: 'label' }, this.required && index.h("span", { class: 'required' }, "*"), this.label);
  }
  renderSubtitle() {
    if (this.error)
      return index.h("div", { class: 'subtitle-error' }, this.error);
    else if (this.success)
      return index.h("div", { class: 'subtitle-success' }, this.success);
    else if (this.warning)
      return index.h("div", { class: 'subtitle-warning' }, this.warning);
    else if (this.caption)
      return index.h("div", { class: 'subtitle-caption' }, this.caption);
  }
  getInputState() {
    if (this.error)
  ...
  render() {
    return (index.h(index.Host, { class: {
      ...
      } }, index.h("div", { class: { 'form-control': true, 'inline': this.inline } }, this.renderLabel(), index.h("div", { class: 'field' }, index.h("slot", null)), index.h("div", { class: 'subtitle' }, this.renderSubtitle()))));
  }
  get elm() { return index.getElement(this); }
};
...
const Select = class {
  ...
  renderMultiSelectValues() {
    ...
    if (this.multiple && values.length) {
      return values.map((value) => {
        ...
        if (item) {
          return (index.h("goat-tag", { filter: true, class: 'multi-select-value', value: item.value }, item.label));
        }
      });
    }
  }
  render() {
    return (index.h(index.Host, { "has-value": this.hasValue(), "has-focus": this.hasFocus, "is-open": this.isOpen, position: this.position }, index.h("div", { class: { 'dropdown': true, 'select': true, [this.position]: true, 'is-open': this.isOpen } }, index.h("div", { class: {
      ...
      } }, index.h("div", { class: 'slot-container start' }, index.h("slot", { name: 'start' })), index.h("div", { class: 'multi-select-values' }, this.renderMultiSelectValues()), (() => {
      if (this.search !== 'none' && this.isOpen) {
        return index.h("input", Object.assign({ class: 'input input-native', ref: input => this.nativeInput = input, type: 'text', name: this.name, value: this.searchString, placeholder: this.placeholder, onBlur: this.blurHandler, onFocus: this.focusHandler, onInput: this.onInput, onKeyDown: this.keyDownHandler }, this.configAria));
      }
      else {
      ...
      index.h("goat-icon", { class: 'clear input-action', name: 'x-circle-fill', size: this.size, onClick: this.clearInput, role: 'button' }), index.h("div", { class: 'slot-container end' }, index.h("slot", { name: 'end' })), this.getModeIcon()), index.h("div", { class: 'dropdown-content', ref: (elm) => this.dropdownContentElm = elm }, this.isOpen && this.renderDropdownList()))));
  }
  getModeIcon() {
    if (this.showLoader) {
      return index.h("goat-spinner", { class: 'input-action rainbow' });
    }
    if (!this.disabled && !this.readonly)
      return index.h("goat-icon", { name: 'chevron-down', size: this.size, class: 'input-action chevron-down', role: 'button', onClick: this.toggleList });
  }
  renderDropdownList() {
    if (this.search === 'managed' && !this.items.length) {
      return index.h("goat-menu", { class: 'menu', ref: (el) => this.menuElm = el }, index.h("div", { class: 'start-search' }, index.h("goat-icon", { name: 'search', size: this.size }), index.h("goat-text", { shade: 'secondary' }, "Start typing to perform search")));
    }
    if (this.items) {
      const filteredItems = this.filterItems();
      return index.h("goat-menu", { class: 'menu', empty: filteredItems.length == 0, ref: (el) => this.menuElm = el }, (() => {
        return filteredItems.map((item) => {
          return index.h("goat-menu-item", { value: item.value }, item.label || item.value);
        });
      })());
    }
  }
...
exports.goat_checkbox = Checkbox;
exports.goat_form_control = FormControl;
exports.goat_select = Select;

//# sourceMappingURL=goat-checkbox_3.cjs.entry.js.map