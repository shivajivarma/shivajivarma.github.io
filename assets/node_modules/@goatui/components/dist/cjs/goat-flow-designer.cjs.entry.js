...
const FlowDesigner = class {
  ...
  async componentWillLoad() {
    if (!window['SVG']) {
      await utils.loadScript(`https://cdnjs.cloudflare.com/ajax/libs/svg.js/3.1.2/svg.min.js`);
    }
    this.lines = [{
  ...
  render() {
    return index.h(index.Host, { disabled: this.disabled }, index.h("div", { class: 'flow-designer', ref: elm => this.nativeScrollElm = elm }, index.h("div", { class: 'canvas-wrapper', onMouseDown: (event) => {
      ...
      } }, index.h("goat-canvas", { ref: elm => this.canvasElm = elm, class: 'flow-lines', lines: this.lines, padding: 0, viewbox: `0 0 124 134` }), index.h("div", { class: 'flow-items', style: { 'width': `${this.getViewBoxWidth()}px`, 'height': `${this.getViewBoxHeight()}px` } }))));
  }
  get elm() { return index.getElement(this); }
};
FlowDesigner.style = flowDesignerCss;

exports.goat_flow_designer = FlowDesigner;

//# sourceMappingURL=goat-flow-designer.cjs.entry.js.map