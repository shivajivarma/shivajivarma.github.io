...
const Input = class {
  ...
  debounceChanged() {
    this.goatChange = utils.debounceEvent(this.goatChange, this.debounce);
  }
  componentWillLoad() {
  ...
  render() {
    return (index.h(index.Host, { "has-focus": this.hasFocus, "has-value": this.hasValue() }, index.h("div", { class: {
        'input-container': true,
        'disabled': this.disabled,
        'has-focus': this.hasFocus,
        'start-slot-has-content': this.startSlotHasContent,
        'end-slot-has-content': this.endSlotHasContent,
      } }, index.h("div", { class: 'slot-container start' }, index.h("slot", { name: 'start' })), index.h("input", Object.assign({ class: 'input input-native', name: this.name, ref: input => this.nativeInput = input, type: this.type, placeholder: this.placeholder, autocomplete: this.autocomplete, value: this.value, tabindex: this.tabindex, readonly: this.readonly, required: this.required, onKeyDown: this.keyDownHandler, onInput: this.inputHandler, onBlur: this.blurHandler, onFocus: this.focusHandler, disabled: this.disabled }, this.configAria)), this.clearable && this.hasValue() &&
      index.h("goat-icon", { class: 'clear inherit input-action', name: 'x-circle-fill', size: this.size, onClick: this.clearInput, role: "button" }), index.h("div", { class: 'slot-container end' }, index.h("slot", { name: 'end' })))));
  }
...
exports.goat_input = Input;

//# sourceMappingURL=goat-input.cjs.entry.js.map