...
const Textarea = class {
  constructor(hostRef) {
    ...
    this.p4Input = index.createEvent(this, "goat:input", 7);
    this.p4Change = index.createEvent(this, "goat:change", 7);
    this.p4Blur = index.createEvent(this, "goat:blur", 7);
    this.p4Focus = index.createEvent(this, "goat:focus", 7);
  ...
  render() {
    return (index.h(index.Host, { "has-focus": this.hasFocus, "has-value": this.hasValue() }, index.h("div", { class: {
      ...
      index.h("goat-icon", { class: 'clear inherit input-action', name: 'x-circle-fill', onClick: this.clearInput }), index.h("div", { class: 'slot-container end' }, index.h("slot", { name: 'end' })))));
  }
...
exports.goat_textarea = Textarea;

//# sourceMappingURL=goat-textarea.cjs.entry.js.map