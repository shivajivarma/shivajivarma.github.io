...
const HeaderBrand = class {
  ...
  render() {
    ...
    return (index.h("div", { class: 'header-brand' }, index.h("goat-link", { class: 'brand-link full-height no-style', href: this.href }, index.h("div", { class: 'brand' }, (() => {
      if (this.logo) {
        if (isLogoSVG) {
          return index.h("goat-svg", { class: 'logo inherit', src: this.logo });
        }
        else {
          return index.h("img", { src: this.logo, class: 'logo', alt: this.name });
        }
      }
    })(), this.name && index.h("span", { class: 'brand-name' }, this.name))), (() => {
      if (this.subTitle)
        return index.h(index.Fragment, null, index.h("goat-divider", { vertical: true, class: 'subtitle-divider' }), index.h("div", { class: 'subtitle' }, this.subTitle));
    })()));
  }
};
HeaderBrand.style = headerBrandCss;

exports.goat_header_brand = HeaderBrand;

//# sourceMappingURL=goat-header-brand.cjs.entry.js.map