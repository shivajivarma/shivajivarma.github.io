...
const Tab = class {
  constructor(hostRef) {
    ...
    this.goatTabClick = index.createEvent(this, "goat:tab-click", 7);
  ...
  render() {
    return (index.h(index.Host, { "has-focus": this.hasFocus, active: this.isActive }, index.h("div", { class: {
      ...
      } }, index.h("div", { class: 'tab-background' }), index.h("button", { class: 'native-button', tabindex: this.tabindex, ref: input => this.nativeInput = input, onBlur: this.blurHandler, onFocus: this.focusHandler, onClick: this.clickHandler, onMouseDown: this.mouseDownHandler, onKeyDown: this.keyDownHandler, disabled: this.disabled, "aria-describedby": this.disabled && this.disabledReason ? `disabled-reason-${this.gid}` : null, "aria-disabled": (this.disabled || this.showLoader) + '' }, index.h("div", { class: 'tab-content' }, this.showLoader && index.h("goat-spinner", { class: 'spinner inherit', size: this.getIconSize() }), !this.showLoader && this.icon && this.renderIcon(), !this.showLoader && index.h("div", { class: 'slot-container' }, index.h("slot", null)))), this.renderDisabledReason())));
  }
  get elm() { return index.getElement(this); }
};
Tab.style = tabCss;

exports.goat_tab = Tab;

//# sourceMappingURL=goat-tab.cjs.entry.js.map