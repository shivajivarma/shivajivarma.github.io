...
.link {
  ...
  color: var(--link-color, var(--link-01, var(--color-blue-60, #0f62fe)));
}
.link:hover {
  color: var(--link-color-hover, var(--hover-primary-text, var(--color-blue-70, #0043ce)));
  text-decoration: var(--link-decoration-hover, underline);
}
.link:visited {
  color: var(--link-color-visited, var(--visited-link, #8a3ffc));
}
.link.active {
  color: var(--link-color-active, var(--text-primary, var(--color-gray-100, #161616)));
}
