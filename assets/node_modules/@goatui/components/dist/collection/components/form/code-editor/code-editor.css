...
.monaco-hover code {
  font-family: v(monaco-monospace-font);
}
...
.monaco-keybinding > .monaco-keybinding-key {
  ...
  border-radius: 3px;
  box-shadow: inset 0 -1px 0 rgba(186, 186, 186, 0.4);
...
.monaco-split-view2.separator-border > .split-view-container > .split-view-view:not(:first-child):before {
  ...
  z-index: 2;
  pointer-events: none;
  background-color: v(separator-border);
}
...
.monaco-editor .codicon-lightbulb, .monaco-editor .lightbulb-glyph {
  display: flex;
  align-items: center;
  justify-content: center;
  height: 16px;
...
.monaco-editor .codicon-lightbulb:hover, .monaco-editor .lightbulb-glyph:hover {
  cursor: pointer;
}
...
.monaco-list .monaco-list-row.focused.selected .outline-element .monaco-highlighted-label, .monaco-list .monaco-list-row.focused.selected .outline-element-decoration {
  color: inherit !important;
}
...
.monaco-editor .suggest-widget > .details, .monaco-editor .suggest-widget > .message, .monaco-editor .suggest-widget > .tree {
  width: 100%;
  border-style: solid;
  border-width: 1px;
  box-sizing: border-box;
...
.monaco-editor.hc-black .suggest-widget > .details, .monaco-editor.hc-black .suggest-widget > .message, .monaco-editor.hc-black .suggest-widget > .tree {
  border-width: 2px;
}
...
.monaco-editor .suggest-widget.docs-side > .details, .monaco-editor .suggest-widget.docs-side > .tree {
  width: 50%;
  float: left;
}

.monaco-editor .suggest-widget.docs-side.list-right > .details, .monaco-editor .suggest-widget.docs-side.list-right > .tree {
  float: right;
}

.monaco-editor .suggest-widget > .details ol, .monaco-editor .suggest-widget > .details ul {
  padding-left: 20px;
}
...
.monaco-editor .suggest-widget .details > .monaco-scrollable-element > .body > .header > .codicon-close, .monaco-editor .suggest-widget .monaco-list .monaco-list-row > .contents > .main > .right > .readMore:before {
  color: inherit;
  opacity: 1;
  font-size: 14px;
  cursor: pointer;
...
.monaco-editor .suggest-widget .monaco-list .monaco-list-row > .contents > .main > .left > .qualifier-label, .monaco-editor .suggest-widget .monaco-list .monaco-list-row > .contents > .main > .left > .signature-label, .monaco-editor .suggest-widget .monaco-list .monaco-list-row > .contents > .main > .right > .details-label {
  opacity: 0.7;
}
...
.monaco-editor .suggest-widget .monaco-list .monaco-list-row.focused > .contents > .main > .right > .details-label, .monaco-editor .suggest-widget .monaco-list .monaco-list-row:not(.string-label) > .contents > .main > .right > .details-label, .monaco-editor .suggest-widget.docs-side .monaco-list .monaco-list-row.focused:not(.string-label) > .contents > .main > .right > .details-label {
  display: inline;
}
...
::selection {
  ...
  background: var(--color-primary, var(--color-blue-60, #0f62fe));
}
...
.code-editor-component .editor {
  height: 100%;
  min-height: 2rem;
  border: 1px solid var(--border-color, var(--color-gray-50, #8d8d8d));
  border-radius: var(--border-radius, 3px);
  overflow: hidden;
}
.code-editor-component .editor[readonly], .code-editor-component .editor[readonly=true] {
  color: var(--color-neutral, var(--color-gray-60, #6f6f6f));
  background-color: var(--color-neutral-10, var(--color-gray-10, #f4f4f4));
  border-color: var(--color-neutral, var(--color-gray-60, #6f6f6f));
  cursor: default;
}
.code-editor-component .editor[disabled], .code-editor-component .editor[disabled=true] {
  color: var(--color-neutral, var(--color-gray-60, #6f6f6f));
  background-color: var(--color-neutral-10, var(--color-gray-10, #f4f4f4));
  border-color: var(--color-neutral, var(--color-gray-60, #6f6f6f));
  cursor: not-allowed;
}
.code-editor-component.disabled .monaco-editor, .code-editor-component.disabled .monaco-editor-background, .code-editor-component.disabled .monaco-editor .inputarea.ime-input, .code-editor-component.disabled .view-lines {
  cursor: default;
}
.code-editor-component.disabled.vs-light .monaco-editor, .code-editor-component.disabled.vs-light .monaco-editor-background, .code-editor-component.disabled.vs-light .monaco-editor .inputarea.ime-input, .code-editor-component.disabled.vs-light .monaco-editor .margin {
  background: var(--color-neutral-200, );
}
.code-editor-component.disabled.vs-dark .monaco-editor, .code-editor-component.disabled.vs-dark .monaco-editor-background, .code-editor-component.disabled.vs-dark .monaco-editor .inputarea.ime-input, .code-editor-component.disabled.vs-dark .monaco-editor .margin {
...
.code-editor-component.has-focus .editor {
  outline: 2px solid var(--color-primary, var(--color-blue-60, #0f62fe));
  border-color: transparent;
}

:host-context(.input-state-success) .code-editor-component .editor {
  border-color: var(--support-success, #198038);
}
:host-context(.input-state-success) .code-editor-component.has-focus .editor {
  outline: 2px solid var(--support-success, #198038);
}

:host-context(.input-state-warning) .code-editor-component .editor {
  border-color: var(--support-warning, #f1c21b);
}
:host-context(.input-state-warning) .code-editor-component.has-focus .editor {
  outline: 2px solid var(--support-warning, #f1c21b);
}

:host-context(.input-state-error) .code-editor-component .editor {
  border-color: var(--support-error, #da1e28);
}
:host-context(.input-state-error) .code-editor-component.has-focus .editor {
