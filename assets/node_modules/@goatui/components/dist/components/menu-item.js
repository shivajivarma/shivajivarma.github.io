...
const GoatMenu = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
...
function defineCustomElement() {
  ...
  const components = ["goat-menu-item"];
  components.forEach(tagName => { switch (tagName) {
    case "goat-menu-item":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, GoatMenu);
      }
      break;
  } });
}

export { GoatMenu as G, defineCustomElement as d };
