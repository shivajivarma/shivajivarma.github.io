...
const Header = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  ...
  renderLeftSection() {
    return (h("div", { class: 'left-section section' }, h("slot", { name: 'left-section' })));
  }
  renderRightSection() {
    return (h("div", { class: 'right-section section' }, h("slot", { name: 'right-section' })));
  }
  render() {
    return (h("header", { class: { 'header': true } }, h("div", { class: 'header-content' }, this.renderLeftSection(), this.renderRightSection())));
  }
...
const GoatHeader = Header;
const defineCustomElement = defineCustomElement$1;

export { GoatHeader, defineCustomElement };

//# sourceMappingURL=goat-header.js.map