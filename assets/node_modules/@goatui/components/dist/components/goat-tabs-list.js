...
const TabsList = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return tabsListCss; }
    ...
    "variant": [1],
    "managed": [4]
  }, [[0, "goat:tab-click", "tabClick"]]]);
function defineCustomElement$1() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["goat-tabs-list"];
  components.forEach(tagName => { switch (tagName) {
    case "goat-tabs-list":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, TabsList);
      }
      break;
  } });
}

const GoatTabsList = TabsList;
const defineCustomElement = defineCustomElement$1;

export { GoatTabsList, defineCustomElement };

//# sourceMappingURL=goat-tabs-list.js.map