...
import { d as defineCustomElement$2 } from './canvas.js';
...
const FlowDesigner = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  get elm() { return this; }
  static get style() { return flowDesignerCss; }
}, [1, "goat-flow-designer", {
    ...
    "activityWidth": [32],
    "lines": [32]
  }, [[0, "mouseup", "handleMouseDown"]]]);
function defineCustomElement$1() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["goat-flow-designer", "goat-canvas"];
  components.forEach(tagName => { switch (tagName) {
    case "goat-flow-designer":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, FlowDesigner);
      }
      break;
    case "goat-canvas":
      if (!customElements.get(tagName)) {
...
const GoatFlowDesigner = FlowDesigner;
const defineCustomElement = defineCustomElement$1;

export { GoatFlowDesigner, defineCustomElement };

//# sourceMappingURL=goat-flow-designer.js.map