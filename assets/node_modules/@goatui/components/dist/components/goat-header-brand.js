...
import { d as defineCustomElement$2 } from './svg.js';
...
const HeaderBrand = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return headerBrandCss; }
}, [1, "goat-header-brand", {
    "logo": [1],
    "name": [1],
    "href": [1],
...
function defineCustomElement$1() {
  ...
  const components = ["goat-header-brand", "goat-divider", "goat-link", "goat-svg"];
  components.forEach(tagName => { switch (tagName) {
    case "goat-header-brand":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, HeaderBrand);
      }
      break;
    case "goat-divider":
      if (!customElements.get(tagName)) {
...
const GoatHeaderBrand = HeaderBrand;
const defineCustomElement = defineCustomElement$1;

export { GoatHeaderBrand, defineCustomElement };

//# sourceMappingURL=goat-header-brand.js.map