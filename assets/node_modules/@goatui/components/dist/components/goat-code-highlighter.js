...
import { l as loadScript } from './utils.js';
...
const CodeHighlighter = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return codeHighlighterCss; }
}, [1, "goat-code-highlighter", {
    "language": [1],
    "lineNumbers": [4, "line-numbers"],
    "value": [1],
    "compiledCode": [32]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["goat-code-highlighter", "goat-button", "goat-icon", "goat-spinner"];
  components.forEach(tagName => { switch (tagName) {
    case "goat-code-highlighter":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, CodeHighlighter);
      }
      break;
    case "goat-button":
      if (!customElements.get(tagName)) {
...
const GoatCodeHighlighter = CodeHighlighter;
const defineCustomElement = defineCustomElement$1;

export { GoatCodeHighlighter, defineCustomElement };

//# sourceMappingURL=goat-code-highlighter.js.map