...
import { g as getComponentIndex, d as debounceEvent } from './utils.js';
...
const Input = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    ...
    this.__registerHost();
    this.__attachShadow();
    this.goatInput = createEvent(this, "goat:input", 7);
...
function defineCustomElement$1() {
  ...
  const components = ["goat-input", "goat-icon"];
...
const GoatInput = Input;
const defineCustomElement = defineCustomElement$1;

export { GoatInput, defineCustomElement };

//# sourceMappingURL=goat-input.js.map