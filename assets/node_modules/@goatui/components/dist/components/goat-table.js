...
import { d as defineCustomElement$b } from './empty-state.js';
import { d as defineCustomElement$a } from './form-control.js';
...
function defineCustomElement$1() {
  ...
  const components = ["goat-table", "goat-button", "goat-checkbox", "goat-empty-state", "goat-form-control", "goat-icon", "goat-menu", "goat-menu-item", "goat-select", "goat-spinner", "goat-svg", "goat-tag", "goat-text"];
...
const GoatTable = Table;
const defineCustomElement = defineCustomElement$1;

export { GoatTable, defineCustomElement };

//# sourceMappingURL=goat-table.js.map