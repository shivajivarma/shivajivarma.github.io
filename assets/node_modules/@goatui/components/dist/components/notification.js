...
import { c as isDarkMode, o as observeThemeChange, E as ElementSize } from './utils.js';
...
function defineCustomElement() {
  ...
  const components = ["goat-notification", "goat-button", "goat-icon", "goat-spinner"];
  components.forEach(tagName => { switch (tagName) {
    case "goat-notification":
