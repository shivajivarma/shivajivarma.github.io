...
import { l as loadScript, g as getComponentIndex, d as debounceEvent } from './utils.js';
...
const CodeEditor = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  render() {
    return (h(Host, null, h("div", { class: {
      ...
      } }, h("div", { class: 'editor', ref: el => this.editorElement = el }), !this.editorMonacoInstance && h("div", { class: 'code-editor-loader' }, h("goat-spinner", { class: 'rainbow' }), "Loading editor..."))));
  }
  ...
  static get style() { return codeEditorCss; }
    ...
    "theme": [1],
    "language": [1],
    "lineNumbers": [1, "line-numbers"],
    "debounce": [2],
    "hasFocus": [32],
    "editorMonacoInstance": [32],
    "getComponentId": [64],
    "setFocus": [64],
    "setBlur": [64]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["goat-code-editor", "goat-spinner"];
  components.forEach(tagName => { switch (tagName) {
    case "goat-code-editor":
...
const GoatCodeEditor = CodeEditor;
const defineCustomElement = defineCustomElement$1;

export { GoatCodeEditor, defineCustomElement };

//# sourceMappingURL=goat-code-editor.js.map